...
const CardSwap: React.FC<CardSwapProps> = ({
    ...
    return (
        <div
            ref={container}
            className="absolute bottom-0 right-0 transform translate-x-[5%] translate-y-[20%] origin-bottom-right perspective-[900px] overflow-visible max-[768px]:translate-x-[15%] max-[768px]:translate-y-[25%] max-[768px]:scale-[0.8] max-[480px]:translate-x-[10%] max-[480px]:translate-y-[30%] max-[480px]:scale-[0.6]"
            style={{ width, height }}
        >
            {rendered}
        </div>
